...
penguins = neopixel.NeoPixel(board.D0, 600, brightness=0.2, auto_write=False, pixel_order=neopixel.RGB)
...
while True:
    ...
    if r % 2 == 0:
        if arms1 == 0:
            ...
            penguins[90] = DBLUE
            penguins[88] = DBLUE
            penguins[78:86] = [DBLUE]*8
            penguins[112] = DBLUE
            penguins[117] = DBLUE
            penguins[119] = DBLUE
            penguins[124:130] = [DBLUE]*6
            # turn bottom off
            penguins[71:78] = [OFF]*7
            penguins[87] = OFF
            penguins[89] = OFF
            penguins[118] = OFF
            penguins[120] = OFF
            penguins[130:137] = [OFF]*7
            #penguins.show()
            #time.sleep(5)
        elif arms1 == 1:
            # put arms down
            ...
            penguins[90] = OFF
            penguins[88] = OFF
            penguins[78:86] = [OFF]*8
            # turn bottom on
            penguins[71:78] = [DBLUE]*7
            penguins[84] = DBLUE
            penguins[87] = DBLUE
            penguins[89] = DBLUE
    ...
    if r % 2 == 0:
        if arms2 == 0:
            ...
            penguins[340] = DBLUE
            penguins[338] = DBLUE
            penguins[328:336] = [DBLUE]*8
            penguins[366] = DBLUE
            penguins[367] = DBLUE
            penguins[369] = DBLUE
            penguins[372] = DBLUE
            penguins[374:380] = [DBLUE]*6

            # turn bottom off
            penguins[321:328] = [OFF]*7
            penguins[337] = OFF
            penguins[339] = OFF
            penguins[368] = OFF
            penguins[370] = OFF
            penguins[380:387] = [OFF]*7
            #penguins.show()
            #time.sleep(5)
        elif arms2 == 1:
            # put arms down
    ...
    penguins[0:50] = [OFF]*50
    penguins[252:300] = [OFF]*48
    penguins[502:554] = [OFF]*52
    penguins[555:595] = [colors[count%len(colors)]]*40
    penguins[595:600] = [OFF]*5
    penguins.show()
    if count == 0:
